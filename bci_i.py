...
class WindowClass(QMainWindow):
    ...
    def btn_1_clicked(self):
        ...
        QTimer.singleShot(ref+r_num+500,self.save)
        
            
    def pr_data(self,trial,data_list):
        data = board.get_board_data()
        print(data.shape)
        globals()['data{}'.format(trial)]=pd.DataFrame(globals()['data{}'.format(trial)])
        data_list.append(globals()['data{}'.format(trial)])
        
    def save(self,data_list):
        data_save=pd.concat(data_list)
